...
public class NetworkHandler {
    ...
    public static ServerCell[][] getServerChunk(int numServers, ServerGrid readGrid, int offset) {
        ...
        for(int rowNumber = 0; rowNumber < readGrid.Cells.length; rowNumber++) {
            ...
            serverChunk[rowNumber] = ServerCell.cloneCellLine(readGrid.Cells[rowNumber + offset]);
